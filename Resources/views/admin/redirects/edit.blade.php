...
@section('content-header')
    <h1>
        {{ trans('redirect::redirects.title.edit redirect') }}
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('core::core.breadcrumb.home') }}</a></li>
        <li><a href="{{ route('admin.redirect.redirect.index') }}">{{ trans('redirect::redirects.title.redirects') }}</a></li>
        <li class="active">{{ trans('redirect::redirects.title.edit redirect') }}</li>
    </ol>
@stop

@section('content')
    {!! Form::open(['route' => ['admin.redirect.redirect.update', $redirect->id], 'method' => 'put']) !!}
    <div class="row">
        <div class="col-md-10">
            <div class="box">
                <div class="box-body">
        ...
        <div class="col-md-2">
            <div class="box">
                <div class="box-body">
                    {!! Form::normalSelect('status', trans('redirect::redirects.form.status'), $errors, $redirectStatuses, $redirect) !!}
                </div>
            </div>
        </div>
    </div>
